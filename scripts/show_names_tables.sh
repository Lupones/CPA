...
sudo python3 ./show_names_tables.py -w $workloads -id $inputdir -od $outputdir -n stp -n antt -n power/energy-pkg/ -n power/energy-ram/ -n interval -n unfairness -n ipc -n geoipc -p noPart -p Dunn -p CA -p CPA -p CPA_no_LLC 
